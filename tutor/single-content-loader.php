...
<div style="background-image: url(<?php echo $quiz_bg; ?>);"  class="wrap px-4">

<div class="tutor-course-single-content-wrapper<?php echo $enable_spotlight_mode ? ' tutor-spotlight-mode' : ''; ?> container mx-auto">
