...
if ( $is_instructor ) {
	...
	<div class="tutor-container">
		<div class="tutor-instructor-application-process tutor-pt-48 tutor-pb-48">
			<div class="tutor-app-process-alert m-auto max-w-[920px]">
			...
			<div class="tutor-instructor-application-body">
				<div class="tutor-ins-app-title tutor-m-auto tutor-text-center">
					<span class="tutor-app-process-title tutor-fs-3 tutor-fw-medium tutor-color-black leading-10">
					<?php
					if ( 'pending' == $instructor_status ) {
	...
	<style>
		.tutor-bg-primary {background:#000;color:#fff;border-radius:200px;}
	    .tutor-bg-primary:hover{background:#1D1F1E;color:#fff}
	</style>
